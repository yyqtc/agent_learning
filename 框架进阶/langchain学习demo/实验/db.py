...
def _init_vector_store(path: str, collection_name: str) -> Chroma:
    ...
    try:
        ...
        # print("\n============== db begin ==============\n")
        # print(f"{collection_name}: {vectorstore.get()}")
        # print("\n==============  db end  ==============\n")
        return vectorstore
